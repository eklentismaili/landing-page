  ...
  return (
    <div className="privacy pages">
      ...
      <div className="row">
        ...
        <h2 className="pt-5 text-center text-color-blue">Privacy Policy</h2>
                <SingleLine></SingleLine>
                <p className="pt-5">Your privacy is important to us. It is Our policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, and other sites we own and operate. </p>
                <p>This policy is effective as of January 2022 and was last updated on January 2022. </p>
                <h4 className="py-3 text-center text-color-blue">Information We Collect</h4>
                ...
                <h4 className="py-3 text-center text-color-blue">Use of Cookies</h4>
                ...
                <h4 className="py-3 text-center text-color-blue">Limits of Our Policy</h4>
                <p>Our website may link to external sites that are not operated by us. Please be aware that we have no control over the content and policies of those sites, and cannot accept responsibility or liability for their respective privacy practices. </p>
                <h4 className="py-3 text-center text-color-blue">Contact Us</h4>
                <p>For any questions or concerns regarding your privacy, you may contact us.</p>
        </div>
      </div>
    </div>
    </div>
